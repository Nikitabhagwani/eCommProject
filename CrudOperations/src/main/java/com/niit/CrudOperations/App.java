...
public class App {
	...
	ApplicationContext context=new AnnotationConfigApplicationContext(DBConfiguration.class,ProductDaoImpl.class,CategoryDaoImpl.class,CartItemDaoImpl.class);
