...
//tells the Spring Container to create a bean of type categoryDao
//name of the bean - categoryDaoImpl
@Repository
@Transactional
...
private SessionFactory sessionFactory;	
	...
	public Category saveCategory(Category category) {//id=0,categoryname="pen",categorydesc="pen",price=100,quantity=10
        	...
        	session.save(category); //generate an insernt query, insert the data into category table
	...
	public List<Category> getAllCategorys() {
		...
		// List<category>
		Query query=(Query)session.createQuery("from categorys");//category is an entity 
		List<Category> categorys=(List) query.list();
